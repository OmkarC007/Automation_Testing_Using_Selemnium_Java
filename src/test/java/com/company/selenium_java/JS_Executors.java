...
public class JS_Executors {
	...
	public void enterText_intoDisabledTextbox() throws InterruptedException {
		...
		driver.get("file:///C:/Selenium/javascriptExecutor.html");
	...
	public void ScrollDownTo_SpecificElemnt() throws InterruptedException {
		...
		WebElement ele = driver.findElement(By.xpath("//img[@class='product-image _deals-shoveler-v2_style_dealImage__3nlqg'][@alt='Bestselling headphones from boAt']"));
