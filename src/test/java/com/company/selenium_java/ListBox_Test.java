...
public class ListBox_Test {
	...
	@Test	
	public void litsBoxExample()throws InterruptedException{
		driver.get("file:///C:/Selenium/breakfast.html");
	...
	@Test
	public void printListValue_SortedOrder() throws InterruptedException{
		driver.get("file:///C:/Selenium/breakfast.html");
	...
	@Test
	public void HashMap_printtheOcuuranceOfPoori()throws InterruptedException{
		driver.get("file:///C:/Selenium/breakfast.html");
		WebElement list = driver.findElement(By.id("mtr"));
		Select s = new Select(list);
		...
		for (WebElement element : allElements) {
			...
			if (hashMapObj.containsKey(text)) { 
				...
				value++; hashMapObj.put(text, value); 
			}else{ hashMapObj.put(text, 1); 
			} 
		} 
	...
	@Test
	public void checkListDUPLICATEvalues_HashSet() throws InterruptedException{
		driver.get("file:///C:/Selenium/breakfast.html");
		WebElement list = driver.findElement(By.id("mtr"));
		Select s = new Select(list);
		List<WebElement> allOptions = s.getOptions();
	...
	@Test
	public void PrintDUPLICATEItem_intheList_HashSet()throws InterruptedException{
		driver.get("C:\\Users\\Lenovo\\Documents\\ListBox_Breakfast.html");
		WebElement list = driver.findElement(By.id("mtr"));
		Select s = new Select(list);
		List<WebElement> allOptions = s.getOptions();
		int count1 = allOptions.size();
